...
vim.keymap.set("n", "<localleader>w", "<cmd>set wrap!<cr>", {buffer = true, desc = "toggle line wrap", noremap = true})
return vim.keymap.set("n", "<localleader>c", "<cmd>Obsidian toggle_checkbox<cr>", {buffer = true, desc = "toggle checkbox", noremap = true})
