...
local function set_options()
  ...
  local options = {termguicolors = true, signcolumn = "auto:2", conceallevel = 2, completeopt = "menu,menuone,noselect", diffopt = "internal,filler,closeoff,algorithm:patience,inline:char", encoding = "utf-8", expandtab = true, foldexpr = "nvim_treesitter#foldexpr()", foldmethod = "expr", foldlevel = 9, fillchars = "vert:\226\148\131,diff:\226\149\177", guifont = "JetBrainsMono Nerd Font:h18", hlsearch = true, ignorecase = true, list = true, listchars = "tab:\226\150\182-,trail:\226\128\162,extends:\194\187,precedes:\194\171", mouse = "a", number = true, pumheight = 5, relativenumber = true, ruler = true, shiftwidth = 2, smartcase = true, spelllang = "en_us", splitbelow = true, splitright = true, tabstop = 2, wildmenu = true, wrap = false}
