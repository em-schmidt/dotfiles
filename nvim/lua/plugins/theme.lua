...
return {u.tx("projekt0n/github-nvim-theme", {priority = 1000, config = _1_, lazy = false}), u.tx("f-person/auto-dark-mode.nvim", {opts = {update_interval = 1000, set_dark_mode = _2_, set_light_mode = _3_}}), u.tx("SmiteshP/nvim-navic", {config = _4_}), u.tx("nvim-lualine/lualine.nvim", {dependencies = {"nvim-tree/nvim-web-devicons"}, opts = {extensions = {"nvim-tree", "toggleterm", "trouble", "fugitive"}, options = {theme = "auto", component_separators = "|", section_separators = {left = "\238\130\180", right = "\238\130\182"}}, sections = {lualine_a = {u.tx("mode", {separator = {left = "\238\130\182"}, right_padding = 1})}, lualine_b = {{"filename", {filestatus = true, path = 1}}}, lualine_c = {{"branch"}, {"diff"}}, lualine_x = {{"diagnostics"}}, lualine_y = {{"filetype"}, {"progress"}}, lualine_z = {u.tx("location", {separator = {right = "\238\130\180"}, left_padding = 1})}}}})}
