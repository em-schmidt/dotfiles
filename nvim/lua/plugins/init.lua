...
return {u.tx("Olical/nfnl", {ft = "fennel"}), u.tx("taybart/b64.nvim"), u.tx("folke/todo-comments.nvim", {dependencies = {"nvim-lua/plenary.nvim"}, opts = {}}), u.tx("folke/snacks.nvim", {priority = 1000, opts = {gitbrowse = {enabled = true}, input = {enabled = true}, image = {enabled = true}, notifier = {enabled = true}, picker = {enabled = true}, statuscolumn = {}, explorer = {}}, keys = {u.tx("<leader>bb", _1_, {desc = "buffers"}), u.tx("<leader>fe", _2_, {desc = "explorer"}), u.tx("<leader>ft", _3_, {desc = "explorer"}), u.tx("<leader>ff", _4_, {desc = "files"}), u.tx("<leader>f/", _5_, {desc = "grep"}), u.tx("<leader>gB", _6_, {desc = "open git in browser"}), u.tx("<leader>gl", _7_, {desc = "git log"}), u.tx("<leader>gs", _8_, {desc = "git status"}), u.tx("<leader>Nh", _9_, {desc = "notificaiton history"}), u.tx("<leader>Nd", _10_, {desc = "dismiss notifications"}), u.tx("<leader>pp", _11_, {desc = "projects"}), u.tx("<leader>pt", _12_, {desc = "TODOs"})}, lazy = false}), u.tx("folke/trouble.nvim", {opts = {}}), u.tx("akinsho/toggleterm.nvim", {opts = {}}), u.tx("ahmedkhalf/project.nvim", {config = _13_}), u.tx("windwp/nvim-autopairs", {event = "InsertEnter", opts = {}}), u.tx("nacro90/numb.nvim", {opts = {show_numbers = true, show_cursorline = true, numbers_only = true, centered_peeking = true}}), u.tx("gpanders/nvim-parinfer"), u.tx("julienvincent/nvim-paredit", {config = _14_})}
