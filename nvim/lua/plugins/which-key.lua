...
local function _1_()
  do
    ...
    wk.register({g = {name = "git", b = {"<cmd>Gitsigns toggle_current_line_blame<cr>", "toggle git blame"}, s = {"<cmd>Telescope git_status<cr>", "git status"}, l = {"<cmd>Telescope git_commits<cr>", "git log"}}, prefix = "<leader>"})
