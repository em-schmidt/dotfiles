...
local function _1_()
  do
    ...
    wk.register({e = {name = "errors", t = {"<cmd>TroubleToggle<cr>", "toggle trouble view"}}, prefix = "<leader>"})
    ...
    wk.register({g = {name = "git", b = {"<cmd>Gitsigns toggle_current_line_blame<cr>", "toggle git blame"}, s = {"<cmd>Telescope git_status<cr>", "git status"}, l = {"<cmd>Telescope git_commits<cr>", "git log"}, p = {"<cmd>Git pull<cr>", "git pull"}, P = {"<cmd>Git push<cr>", "git push"}}, prefix = "<leader>"})
